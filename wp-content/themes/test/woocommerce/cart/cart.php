        ...
        <div class="col-lg-8 table-responsive mb-5">
            ...
            <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                ...
                <div class="bg-light p-30 mt-3">
                    <button type="submit" class="button btn btn-primary font-weight-bold my-3 py-3" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
