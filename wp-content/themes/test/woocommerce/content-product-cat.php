...
<div <?php wc_product_cat_class( 'col-lg-3 col-md-4 col-sm-6 pb-1 category-list', $category ); ?>>
	...
	?>
        </div> <!--close div class="overflow-hidden" style="width: 100px; height: 100px;"-->
    ...
    ?>
        </div> <!--close tag of flex-fill pl-3-->
	...
	?>
        </div> <!--close tag of cat-item d-flex align-items-center mb-4-->
    <?php
