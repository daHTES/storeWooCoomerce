<?php get_header(); ?>
            ...
            <div class="col-lg-8">
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    <ol class="carousel-indicators">
                        ...
                        <li data-target="#header-carousel" data-slide-to="<? echo $i; ?>" <?php if($i == 0): ?>class="active"><? endif; ?></li>
                        <?php endfor;?>
                    </ol>
                        ...
                        <div class="carousel-item position-relative <?php if($i == 0): ?>active<?php endif; ?>" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="<?php the_permalink();?>"><?php echo __('Shop now', 'test');?></a>
                                </div>
                            </div>
                        </div>
                        <?php $i++; endforeach; ?>
                ...
                <?php else:?>
                    <p><?php echo __('Slider here', 'test');?></p>
    ...
    <!-- Categories Start -->
    <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php _e('Categories', 'test')?></span></h2>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php _e('Featured Products', 'test')?></span></h2>
        <div class="row px-xl-5">
